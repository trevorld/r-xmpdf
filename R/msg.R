...
#' @export
enable_feature_message <- function(
	feature = c(
		"cat_pages",
		"get_bookmarks",
		"get_docinfo",
...
msg_get_bookmarks <- function() {
	c(need_to_install_str("get_bookmarks()"), install_pdftk_str())
}

msg_get_docinfo <- function() {
	c(
		need_to_install_str("get_docinfo()"),
...
msg_get_xmp <- function() {
	c(need_to_install_str("get_xmp()"), install_exiftool_str())
}

msg_n_pages <- function() {
	c(
		need_to_install_str("n_pages()"),
		install_package_str("qpdf"),
		install_exiftool_str(),
		install_pdftk_str(),
		install_gs_str()
...
msg_set_bookmarks <- function() {
	c(need_to_install_str("set_bookmarks()"), install_gs_str(), install_pdftk_str())
}

msg_set_docinfo <- function() {
	c(
		need_to_install_str("set_docinfo()"),
		install_gs_str(),
		install_exiftool_str(),
		install_pdftk_str()
	)
...
msg_set_xmp <- function() {
	c(need_to_install_str("set_xmp()"), install_exiftool_str())
}
